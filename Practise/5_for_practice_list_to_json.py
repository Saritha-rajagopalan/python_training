...
Expected Output in list of tuples:
----------
[
...
# Expected output = [(ip, dt, url),(ip, dt, url),(ip, dt, url),]

output_list = []
for each_line in list_of_lines:
    if each_line.startswith("123"):
        sp = each_line.split()
        # print("Splited Values:", sp)
        ip = sp[0]
...
import json
json.dump(output_list, my_json_file_handle)

my_json_file_handle.close()

print("""
Created log_report_1.json please check
""")

print("#"*40, end="\n\n")
############################

print("Reading 'log_report_1.json'")
print("-"*20)
# -------------
