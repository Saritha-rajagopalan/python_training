...
import pandas as pd
my_json_file_data_1 = pd.read_json(r"C:/python_training/Practise/log_report_1.json")
...
import pandas as pd
my_json_file_data_2 = pd.read_json(r"C:/python_training/Practise/log_report_2.json")
...
import sqlite3
my_db_connection = sqlite3.connect("C:/Users/SarithaMrRajagopalan/my_database.db")
