...
2. Abstraction: End user of the class should know how to use methods
                BUT NO need to know how internally it is implemented
"""
...
print("METHODS/VARIABLE present inside 'str' class object:")
print("-"*20)
# -------------
